...
import TextDisplay from '../components/typography/TextDisplay';
...
export const generateMetadata = ({ params }: Props): Metadata => {
  return {
    title: `Restaurant ${decodeURIComponent(params.restaurantId)}`,
  };
};
    ...
    <>
      ...
      <div className="flex h-full flex-col justify-between gap-8 lg:mx-auto lg:w-max lg:justify-center">
        <div className="flex flex-col gap-3">
          <Link
            href="/"
            className="flex w-max items-center gap-1 rounded-lg border-small border-stroke bg-white px-3 py-2 text-black shadow-box-shadows hover:bg-off-white [&>*]:leading-none"
          >
            <svg
              width="12"
              height="10"
          ...
          <TextDisplay>{restaurant.name}</TextDisplay>
          <StatusBadge
